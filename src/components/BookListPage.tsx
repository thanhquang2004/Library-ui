...
import { useAuth } from "../context/AuthContext"; // ✅ để lấy user từ context

const API_BASE = import.meta.env.VITE_API_BASE; // nhớ dùng đúng tên biến trong .env
  ...
  return (
    ...
    >
      <div className="p-6 space-y-6 flex-1">
        {/* Thanh tìm kiếm + chọn chế độ view */}
